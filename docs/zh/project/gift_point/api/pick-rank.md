...
prev: /zh/project/gift_point/api/pick-pop
next: /zh/project/gift_point/api/redpack-rob
---
...
```json
{
  ...
  "data": {
    "lark": { // 最早打卡者
      "nick": "恶霸",
      "avatar": "https://tfs.alipayobjects.com/images/partner/T1daBiXjtdXXXXXXXX",
      "desc": "15:06:48打卡"
    },
    "lucky": { // 上期获得积分最多者
      "nick": "恶霸",
