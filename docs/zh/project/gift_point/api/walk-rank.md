...
prev: /zh/project/gift_point/api/walk-get
next: /zh/project/gift_point/api/walk-exchange
---
...
```json
{
  ...
  "data": [
    {
      "nick": "果zhi冻先生",
      "avatar": "https://tfs.alipayobjects.com/images/partner/TB10CN.b5FADuNkUvMwXXXTMFXa",
      "count": 6994
    },
    {
      "nick": "我",
      "avatar": "https://tfs.alipayobjects.com/images/partner/T1xgNGXnpaXXXXXXXX",
      "count": 5984
    }
  ],
  "my_count": 6994, // 当前用户步数
  "my_rank": 1, // 当前用户排名
  "my_nick": "Jerry", // 昵称
  "my_avatar": "", // 头像地址
  "rate": 200, // 兑换比例
  "is_exchanged": true // 是否已经兑换
}
```