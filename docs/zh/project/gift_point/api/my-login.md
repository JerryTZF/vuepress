...
prev: /zh/project/gift_point/api/lottery-do
next: /zh/project/gift_point/api/my-auth-info
---
...
> ROUTE: v2/user/login.json

> REQUEST:
```json
{
    "app_id": "2021001169664470",
    "auth_code": "18df4c6e46d14f758d9120a6a13bNX94"
}
```
...
```json
{
    ...
    "status": true,
    "data": {
        "status": "30", // 30:已绑定手机号;20:授权基本信息;10:游客
        "user_id": "2088422568245394"
    }
}
```