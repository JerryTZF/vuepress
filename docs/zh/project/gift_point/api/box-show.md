...
prev: /zh/project/gift_point/api/banner
next: /zh/project/gift_point/api/box-get
---
...
```json
{
    ...
    "data": [
        {
            "box_name": "盲盒1", // 盲盒名称
            "task_sum": 3, // 完成N个任务可开启该盲盒
            "alipay_point_unit": 10, // 集分宝单次发放多少
            "point_unit": 20, // 积分单次发放多少
            "is_get": false // 当日是否已经获取该盲盒
        },
        {
            "box_name": "盲盒2",
            "task_sum": 7,
            "alipay_point_unit": 20,
            "point_unit": 20,
            "is_get": false
        },
        {
        ...
        },
        {
            "box_name": "盲盒4",
            "task_sum": 14,
            "alipay_point_unit": 40,
            "point_unit": 20,
            "is_get": false
        }
    ],
    "done_tasks_sum": 0, // 已完成任务数
    "diff": 3 // 距离下一个可打开的盲盒还差多少个任务
}
```