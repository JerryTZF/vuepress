...
prev: /zh/project/gift_point/api/king-list
next: /zh/project/gift_point/api/lottery-board
---
...
> ROUTE: v2/kingkong/cover_img.json
...
```json
{
  ...
  "status": true,
  "data": {
    "lottery_cover_img": "https://a.com/a.jpg",
    "walk_cover_img": "https://a.com/a.jpg",
    "pickup_cover_img": "https://a.com/a.png"
  }
}
```